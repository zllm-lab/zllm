...
pub(crate) struct TensorFunctions {
    ...
    pub(crate) copy_columns_into: usize,
    pub(crate) copy_columns_into_f32x4: usize,
    ...
    pub(crate) unpack_prepared_attention_qkv_bf16: usize,
    pub(crate) compact_prepared_attention_qkv_bf16: usize,
    pub(crate) pack_attention_kv_native_bf16: usize,
    pub(crate) full_attention: usize,
    pub(crate) full_attention_wide: usize,
    pub(crate) pack_attention_f16_checked: Option<usize>,
    pub(crate) full_attention_wmma_wide: Option<usize>,
    ...
    pub(crate) full_attention_batched_128_zero_margin: usize,
    ...
    pub(crate) group_norm_partial: usize,
    pub(crate) group_norm_finish: usize,
    pub(crate) group_norm_apply: usize,
    ...
    pub(crate) conv3d_tiled: usize,
    pub(crate) conv3d_history_tail: usize,
    pub(crate) conv3d_history_tiled: usize,
    pub(crate) conv3d_history_wmma: Option<usize>,
    pub(crate) conv3d_history_columns: Option<usize>,
    pub(crate) conv3d_pointwise_columns: Option<usize>,
    pub(crate) conv3d_columns_gemm: Option<usize>,
    pub(crate) conv3d_history: usize,
    pub(crate) slice_columns: usize,
    ...
    let result = (|| {
        ...
        Ok((
            ...
            TensorFunctions {
                ...
                copy_columns_into: function("copy_columns_into_f32")?,
                copy_columns_into_f32x4: function("copy_columns_into_f32x4")?,
                ...
                unpack_prepared_attention_qkv_bf16: function("unpack_prepared_attention_qkv_bf16")?,
                compact_prepared_attention_qkv_bf16: function("compact_prepared_attention_qkv_bf16")?,
                pack_attention_kv_native_bf16: function("pack_attention_kv_native_bf16")?,
                full_attention: function("full_attention_f32")?,
                full_attention_wide: function("full_attention_wide_f32")?,
                pack_attention_f16_checked: function("pack_attention_f16_checked").ok(),
                full_attention_wmma_wide: function("full_attention_wmma_wide_f16").ok(),
                ...
                full_attention_batched_128_zero_margin: function("full_attention_batched_f32_128_zero_margin")?,
                ...
                group_norm_partial: function("group_norm_partial_f32")?,
                group_norm_finish: function("group_norm_finish_f32")?,
                group_norm_apply: function("group_norm_apply_f32")?,
                ...
                conv3d_tiled: function("conv3d_tiled_f32")?,
                conv3d_history_tail: function("conv3d_history_tail_f32")?,
                conv3d_history_tiled: function("conv3d_history_tiled_f32")?,
                conv3d_history_wmma: function("conv3d_history_wmma_f16_acc_f32").ok(),
                conv3d_history_columns: function("conv3d_history_columns_f16").ok(),
                conv3d_pointwise_columns: function("conv3d_pointwise_columns_f16").ok(),
                conv3d_columns_gemm: function("conv3d_columns_gemm_f16").ok(),
                conv3d_history: function("conv3d_history_f32")?,
                slice_columns: function("slice_columns_f32")?,
...
/// 跨 device(peer access)buffer 的校验:只查字节数。V4.1 的组源层压缩历史归属
/// 源 stage 的 device,消费层 kernel 经 peer access 直读。
pub(crate) fn validate_peer_resident(buffer: &DeviceBuffer, bytes: usize, what: &str) -> Result<(), String> {
    if buffer.bytes < bytes {
        return Err(format!("{what} resident buffer 字节不足: device={} bytes={}/{}", buffer.device_id, buffer.bytes, bytes));
    }
    Ok(())
}
